  ...
  const groups: GroupType[] = [
    {
      ...
      image: "https://i.namu.wiki/i/snfqOzBTWZBT6TCzj7kWdYJHVykbTJ45KpdlFbHyN1RgvaCtHOucSWducsyC4qVWgBlYbi7DUaFbTtunP5BW1I9MOau4LdTCggAJiF6iK7guwuCUXseAXCGH-yO0_svO9Id2vYbtX5Ov1lHYYEYD4Q.svg",
    },
    {
      id: 2,
      name: "라이즈(riize)",
          ...
          <div className="group-management_card" key={group.id}>
            ...
            <div className="group-management_card-image">
              {group.image ? (
                ...
                <div className="group-management_card-placeholder">그룹 이미지<br />혹은<br />그룹 로고</div>
              )}
            </div>
            ...
            <div className="group-management_card-info">
              ...
              <a href={group.sns} target="_blank" rel="noopener noreferrer">
                <img src={instagramIcon} alt="Instagram" className="group-management_instagram-icon" />
              </a>
            </div>
